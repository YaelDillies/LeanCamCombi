...
private lemma Fintype.sum_div_mul_card_choose_card :
  ...
  simp only [sum_congr rfl this, mul_eq_mul_left_iff]
  convert Or.inl $ Finset.sum_range_reflect _ _ with x hx
  rw [tsub_right_comm, ← tsub_add_eq_tsub_tsub, cast_sub (mem_range.1 hx)]
  simp
