...
/-- Variant of `TopologicalSpace.IsTopologicalBasis.isRetrocompact` for an indexed topological
basis. -/
...
/-- Variant of `TopologicalSpace.IsTopologicalBasis.isConstructible` for an indexed topological
basis. -/
